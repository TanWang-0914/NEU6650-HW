...
public class RequestsPerStore implements Runnable{
    ...
    public RequestsPerStore(int storeID, int maxCustID, int maxItemID, int numPurchases, int numItemPerPurchase, String date, int opHour, String basePath, CountDownLatch centralPhaseLatch, CountDownLatch westPhaseLatch, ReqCount reqCount){
